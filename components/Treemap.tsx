...
export default function Treemap({
  ...
  useEffect(() => {
    ...
    // Treemap with compact spacing
    const treemap = d3
      .treemap<any>()
      .size([width, height])
      .paddingOuter(4)
      .paddingTop(24)
      .paddingInner(6) // 6px between boxes for tighter layout
      .round(true);
    ...
    // Sector label chips (more compact)
    groups
      .append("rect")
      .attr("x", (d: any) => d.x0 + 6)
      .attr("y", (d: any) => d.y0 + 6)
      .attr("width", (d: any) => d.data.name.length * 6 + 14)
      .attr("height", 18)
    ...
    cells.each(function(d: any) {
      ...
      if (company.logo && area > 2500) {
        const logoSize = Math.min(width * 0.35, height * 0.35, 36);
